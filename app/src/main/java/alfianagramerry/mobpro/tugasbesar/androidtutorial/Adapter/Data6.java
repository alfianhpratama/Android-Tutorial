...
public class Data6 extends RecyclerView.Adapter<Data6.ViewHolder> {

    private ArrayList<ListData> listData;
    private Context context;

    public Data6(Context context, ArrayList<ListData> listData) {
        this.listData = listData;
        this.context = context;
    }

    @Override
    public Data6.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.list_view, parent, false));
    }

    @Override
    public void onBindViewHolder(Data6.ViewHolder holder, int position) {
