...
public class Data3 extends RecyclerView.Adapter<Data3.ViewHolder> {

    private ArrayList<ListData> listData;
    private Context context;

    public Data3(Context context, ArrayList<ListData> listData) {
        this.listData = listData;
        this.context = context;
    }

    @Override
    public Data3.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.list_view, parent, false));
    }

    @Override
    public void onBindViewHolder(Data3.ViewHolder holder, int position) {
