...
public class Lesson4 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Lesson 4 Material Me");
    ...
    public void onClick(View v) {
        Intent intent = new Intent(this.getActivity(), MaterialMe.class);
