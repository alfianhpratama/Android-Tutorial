...
public class Lesson11 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Lesson 11 DroidCafe");
    ...
    public void onClick(View v) {
        Intent intent = new Intent(this.getActivity(), DroidCafe.class);
