...
public class Data7 extends RecyclerView.Adapter<Data7.ViewHolder> {

    private ArrayList<ListData> listData;
    private Context context;

    public Data7(Context context, ArrayList<ListData> listData) {
        this.listData = listData;
        this.context = context;
    }

    @Override
    public Data7.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.list_view, parent, false));
    }

    @Override
    public void onBindViewHolder(Data7.ViewHolder holder, int position) {
