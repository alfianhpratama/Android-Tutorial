...
public class Data5 extends RecyclerView.Adapter<Data5.ViewHolder> {

    private ArrayList<ListData> listData;
    private Context context;

    public Data5(Context context, ArrayList<ListData> listData) {
        this.listData = listData;
        this.context = context;
    }

    @Override
    public Data5.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.list_view, parent, false));
    }

    @Override
    public void onBindViewHolder(Data5.ViewHolder holder, int position) {
