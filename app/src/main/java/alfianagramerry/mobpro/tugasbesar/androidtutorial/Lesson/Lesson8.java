...
public class Lesson8 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Lesson 8 Notif Me");
    ...
    public void onClick(View v) {
        Intent intent = new Intent(this.getActivity(), NotifyMe.class);
